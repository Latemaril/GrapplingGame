...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Extra Button"",
                    ""type"": ""Value"",
                    ""id"": ""61ede7d6-802b-4c81-9346-7f1695d26425"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                ...
                {
                    ""name"": ""2D Vector"",
                    ""id"": ""29e2c346-45b2-4141-9cac-6536b118617e"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""Up"",
                    ""id"": ""55204e3e-0854-4496-8dbd-6f1504cddcb5"",
                ...
                {
                    ""name"": ""Down"",
                    ""id"": ""85fc85d7-4643-4554-a90d-9ba3dcc1f189"",
    ...
    ""controlSchemes"": [
        ...
        m_XRIRightHandInteraction_ExtraButton = m_XRIRightHandInteraction.FindAction("Extra Button", throwIfNotFound: true);
    ...
    private readonly InputAction m_XRIRightHandInteraction_ExtraButton;
    public struct XRIRightHandInteractionActions
    {
        ...
        public InputAction @ExtraButton => m_Wrapper.m_XRIRightHandInteraction_ExtraButton;
        ...
        public void SetCallbacks(IXRIRightHandInteractionActions instance)
        {
            if (m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface != null)
            {
                ...
                @ExtraButton.started -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnExtraButton;
                @ExtraButton.performed -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnExtraButton;
                @ExtraButton.canceled -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnExtraButton;
            }
